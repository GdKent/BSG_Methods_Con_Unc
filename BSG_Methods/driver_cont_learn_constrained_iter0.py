...
stopping_times = [50, 100, 150, 200, 250] 
...
filename = 'exp_out_dict_CL_constrained_iterations_large.pkl'
...
string = 'CL_constrained_iterations_large.pdf'
...
## Uncomment the next line to save the plot
string = 'CL_constrained_iterations_large_accuracy.pdf'
fig.savefig(string, dpi = 100, format='pdf')
