...
max_iter = 1000 #1000 iter if use_stopping_iter == True #5000iter if use_stopping_iter == False
...
plot_color_list = ['#1f77b4','#9467bd','#bcbd22','#ff7f0e']
# List of names for the algorithms in the legends of the plots
plot_legend_list = ['BSG-N-FD (inc. acc.)','SIGD (inc. acc.)','BSG-H (inc. acc.)']  
...
# SIGD (inc. acc.)
exp_param_dict[1] = {'algo': 'sigd', 'algo_full_name': 'sigd', 'ul_lr': 0.000001, 'll_lr': 0.001, 'use_stopping_iter': use_stopping_iter, \
                      'max_iter': max_iter, 'stopping_time': stopping_time, 'inc_acc': True, 'hess': True, 'normalize': False, 'constrained': True, 'iprint': iprint}  
...
filename = 'exp_out_dict_linear_y_stochastic_high_noise_iterations.pkl'

write_read = 0 ## 1 to write results, 0 to read results
...
string = 'linear_y_stochastic_high_noise_iterations.pdf'
