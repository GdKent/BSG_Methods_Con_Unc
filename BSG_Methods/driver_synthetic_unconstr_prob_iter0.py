...
# BSG-H (inc. acc.)
exp_param_dict[2] = {'algo': 'bsg', 'algo_full_name': 'bsghincacc', 'ul_lr': 0.001, 'll_lr': 0.001, 'use_stopping_iter': use_stopping_iter, \
...
filename = 'exp_out_dict_unconstrained_deterministic_iterations.pkl'
...
string = 'unconstrained_deterministic_iterations.pdf'
