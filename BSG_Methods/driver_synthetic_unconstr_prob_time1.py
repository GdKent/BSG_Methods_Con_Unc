...
max_iter = 5000 #2000 iter if use_stopping_iter == True #5000iter if use_stopping_iter == False
...
filename = 'exp_out_dict_unconstrained_stochastic_time.pkl'
...
string = 'unconstrained_stochastic_time.pdf'
