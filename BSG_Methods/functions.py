...
class SyntheticProblem:
    ...
    def __init__(self, x_dim, y_dim, std_dev, ll_std_dev, hess_std_dev, num_constr, constr_type, pen_param = 1e-1, seed=42):
        ...
        self.a = np.random.uniform(0,10,(self.x_dim,1)) 
        self.b = np.random.uniform(0,10,(self.y_dim,1)) 
...
class ContinualLearning:
    ...
    def accuracy_func(self, predictions, targets): # November 2024 Update
        """
        Accuracy calculation function
        """
        # Get the predicted class by taking the argmax along dimension 1
