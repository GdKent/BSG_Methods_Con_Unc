...
filename = 'exp_out_dict_CL_unconstrained_iterations_large_accuracy.pkl'
...
string = 'CL_unconstrained_iterations_large.pdf'
...
## Uncomment the next line to save the plot
string = 'CL_unconstrained_iterations_large_accuracy.pdf'
fig.savefig(string, dpi = 100, format='pdf')
