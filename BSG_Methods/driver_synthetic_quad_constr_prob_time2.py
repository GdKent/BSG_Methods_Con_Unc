...
max_iter = 5000  #500iter if use_stopping_iter == True #5000iter if use_stopping_iter == False
...
filename = 'exp_out_dict_quad_stochastic_time_high_noise.pkl'
...
string = 'quad_stochastic_time_high_noise.pdf'
