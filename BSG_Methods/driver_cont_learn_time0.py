...
max_epochs = 1000 #This should be set to 1000 when running the plots in terms of time 
...
filename = 'exp_out_dict_CL_unconstrained_time_large.pkl'
...
string = 'CL_unconstrained_time_large.pdf'
...
## Uncomment the next line to save the plot
string = 'CL_unconstrained_time_large_accuracy.pdf'
fig.savefig(string, dpi = 100, format='pdf')
