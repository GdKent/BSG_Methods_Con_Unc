...
x_dim_val = 50 # Please note that in the paper, there is a typo. The correct dimension is 50, not 300. We apologize for the oversight.
# Dimension of the lower-level problem 
y_dim_val = 50 # Please note that in the paper, there is a typo. The correct dimension is 50, not 300. We apologize for the oversight.
...
max_iter = 500  #500iter if use_stopping_iter == True #5000iter if use_stopping_iter == False
...
filename = 'exp_out_dict_quad_stochastic_iterations_high_noise.pkl'
...
string = 'quad_stochastic_iterations_high_noise.pdf'
