...
max_epochs = 1 #This should be set to 5 when running the plots in terms of time
# List of times (in seconds) used when use_stopping_iter is False to determine when a new task must be added to the problem
stopping_times = [50, 100, 150, 200, 250] #[200, 400, 600, 800, 1000] constrained #[20, 40, 60, 80, 100] unconstrained
...
# # bsg-CG (inc. acc.)
# exp_param_dict[0] = {'algo': 'bsg', 'algo_full_name': 'bsgincacc', 'ul_lr': 0.001, 'll_lr': 0.005, 'use_stopping_iter': use_stopping_iter, \
...
# # bsg-1 (inc. acc.)
# exp_param_dict[1] = {'algo': 'bsg', 'algo_full_name': 'bsgincacc', 'ul_lr': 0.001, 'll_lr': 0.05, 'use_stopping_iter': use_stopping_iter, \
...
# # darts
# exp_param_dict[2] = {'algo': 'darts', 'algo_full_name': 'darts', 'ul_lr': 0.001, 'll_lr': 1, 'use_stopping_iter': use_stopping_iter, \
...
# # StocBiO (inc. acc.)
# exp_param_dict[3] = {'algo': 'stocbio', 'algo_full_name': 'bsgincacc', 'ul_lr': 0.00001, 'll_lr': 0.005, 'use_stopping_iter': use_stopping_iter, \
...
exp_param_dict[0] = {'algo': 'bsg', 'algo_full_name': 'bsgincacc', 'ul_lr': 0.0001, 'll_lr': 0.001, 'use_stopping_iter': use_stopping_iter, \
                      'max_epochs': max_epochs, 'stopping_times': stopping_times, 'inc_acc': True, 'hess': 'CG-FD', 'normalize': False, 'constrained': True, 'iprint': iprint}
# 'ul_lr': 0.0001, 'll_lr': 0.005 constrained (0.05 doesn't perform well on tasks 1 and 3)

# bsg-1 (inc. acc.)
exp_param_dict[1] = {'algo': 'bsg', 'algo_full_name': 'bsgincacc', 'ul_lr': 0.0001, 'll_lr': 0.0005, 'use_stopping_iter': use_stopping_iter, \
                      'max_epochs': max_epochs, 'stopping_times': stopping_times, 'inc_acc': True, 'hess': False, 'normalize': False, 'constrained': True, 'iprint': iprint}
# 'ul_lr': 0.0001, 'll_lr': 0.005 constrained 
