...
std_dev_val = 5 #0 and 5
ll_std_dev_val = 5 #0 and 5
hess_std_dev_val = 0.05 #0 and 0.05
...
max_iter = 2000    #2000 iter if use_stopping_iter == True #5000iter if use_stopping_iter == False
# Maximum running time (in sec) used when use_stopping_iter is False
stopping_time = 10   #500dim: 40 #2000dim: 900 #400
...
plot_legend_list = ['BSG-N-FD (inc. acc.)','BSG-1 (inc. acc.)','BSG-H (inc. acc.)','DARTS','StocBiO (inc. acc.)']  
...
# BSG-N-FD (inc. acc.)
exp_param_dict[0] = {'algo': 'bsg', 'algo_full_name': 'bsghincacc', 'ul_lr': 0.001, 'll_lr': 0.001, 'use_stopping_iter': use_stopping_iter, \
...
# BSG-1 (inc. acc.)
exp_param_dict[1] = {'algo': 'bsg', 'algo_full_name': 'bsgincacc', 'ul_lr': 0.001, 'll_lr': 0.001, 'use_stopping_iter': use_stopping_iter, \
...
# BSG-H (inc. acc.)
exp_param_dict[2] = {'algo': 'bsg', 'algo_full_name': 'bsghincacc', 'ul_lr': 0.0001, 'll_lr': 0.001, 'use_stopping_iter': use_stopping_iter, \
...
# DARTS
exp_param_dict[3] = {'algo': 'darts', 'algo_full_name': 'darts', 'ul_lr': 0.0001, 'll_lr': 0.001, 'use_stopping_iter': use_stopping_iter, \
                      'max_iter': max_iter, 'stopping_time': stopping_time, 'inc_acc': False, 'hess': False, 'normalize': False, 'constrained': False, 'iprint': iprint} 
                    ##  Best stepsizes for each value of standard deviation
                    ##  500dim: 'ul_lr': 0.0009, 'll_lr': 0.003, 2000, 0-0-005  - 'ul_lr': 0.0009, 'll_lr': 0.0008, 2000, 1-1-005                                                                                                                   
    
# StocBiO (inc. acc.)
exp_param_dict[4] = {'algo': 'stocbio', 'algo_full_name': 'stocbio', 'ul_lr': 0.001, 'll_lr': 0.001, 'use_stopping_iter': use_stopping_iter, \
                      'max_iter': max_iter, 'stopping_time': stopping_time, 'inc_acc': True, 'hess': False, 'normalize': False, 'constrained': False, 'iprint': iprint}                 
                    ##  Best stepsizes for each value of standard deviation
...
# # BSG-N-FD (inc. acc.)
# exp_param_dict[0] = {'algo': 'bsg', 'algo_full_name': 'bsgnfd', 'ul_lr': 0.001, 'll_lr': 0.00000001, 'use_stopping_iter': use_stopping_iter, \
...
# # BSG-1 (inc. acc.)
# exp_param_dict[0] = {'algo': 'bsg', 'algo_full_name': 'bsghincacc', 'ul_lr': 0.0001, 'll_lr': 0.000001, 'use_stopping_iter': use_stopping_iter, \
...
# # BSG-H (inc. acc.)
# exp_param_dict[1] = {'algo': 'bsg', 'algo_full_name': 'bsghincacc', 'ul_lr': 0.0001, 'll_lr': 0.00001, 'use_stopping_iter': use_stopping_iter, \
...
plt.gca().set_ylim([-21000,50000]) #-20000,10000 #50dim -2100,5000 #500dim -50000,5000 #2000dim -200000,200000
